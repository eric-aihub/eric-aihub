...
```
Cloud (AgentHub Admin)          Local Desktop Client
┌─────────────────────┐         ┌──────────────────────┐
│  Tenant Management  │◄──WS───►│  OpenClaw Runtime    │
│  Model Pool         │         │  Local Agent Exec    │
│  Skill / Tool Pool  │         │  Data stays local    │
│  Org Designer       │         │  Zero cloud leakage  │
└─────────────────────┘         └──────────────────────┘
```
